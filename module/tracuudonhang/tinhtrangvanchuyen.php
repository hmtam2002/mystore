<div class="wrap-content mt-4">
    ...
    <div class="row col-md-7 col-lg-6 col-11 mx-auto">
        ...
        <div
            class="col d-flex align-items-center justify-content-center <?= $thongtindonhang['status'] > 4 ? 'd-none' : '' ?>">
    ...
    <div class="row col-md-7 col-lg-6 col-11 mx-auto mt-3">
        ...
        <div class="col d-flex align-items-center justify-content-center">
            <p class="text-center <?= $thongtindonhang['status'] > 4 ? 'text-danger fw-bold' : '' ?>">Đã huỷ
            </p>
        </div>
    </div>
</div>