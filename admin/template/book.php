    ...
    function edit()
    {
        ...
        echo '
            ...
            '">
              ...
              <div class="mb-3">
                <label for="publisher" class="form-label">Tác giả</label>
                <input type="publisher" class="form-control" name="publisher" id="publisher"  value="' .
            $row['publisher'] .'"
              <div class="mb-3">
                <label for="genre" class="form-label">Thể loại</label>
                <input type="number" class="form-control" name="genre" id="genre"  value="' .
            $row['genre'] .
            '">
              </div>
              <div class="mb-3">
