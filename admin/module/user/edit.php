...
} else
{
    ...
    if (!empty($filterAll['id']))
    {
        ...
        if (!empty($user_detail))
        {
            ...
            // setFlashData('userStatus', 'Sửa thành công');
            // setFlashData('smg_type', 'success');
        } else
        {
            setFlashData('userStatus', 'Sửa không thành công');
...
if ($f->isPOST())
{
    ...
    $f->redirect("?cmd=user&act=edit&id=" . $userId);
                    ...
                    <div class="col">
                        <div class="form-group mg-form">
                            ...
                            <input name="password" type="password" class="form-control"
                                placeholder="Không nhập nếu không thay đổi" id="passwordField">
                            <?php
                        ...
                        <div class="form-group mg-form">
                            ...
                            <input name="password_confirm" type="password" class="form-control"
                                placeholder="Không nhập nếu không thay đổi" id="passwordconfirmField">
                            <?php
                            echo $f->formError('password_confirm', '<span class="error">', '</span>', $errors);
                            ?>
                            <div class="form-group form-check mt-2">
                                <input type="checkbox" class="form-check-input" id="showPasswordconfirmCheckbox">
                                <label class="form-check-label" for="showPasswordconfirmCheckbox">Hiện mật khẩu</label>
                            </div>
                        </div>
