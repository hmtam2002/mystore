...
(1, 'Thiên Long', 1, '2024-05-24 20:55:17', '2024-05-30 10:28:49'),
...
INSERT INTO `cart` (`id`, `custommer_id`, `product_id`, `quantity`, `create_at`) VALUES
(1, 1, 65, 9, '2024-06-01 12:10:43'),
(2, 1, 9, 8, '2024-06-01 12:10:56');
...
--
-- Đang đổ dữ liệu cho bảng `custommers`
--

INSERT INTO `custommers` (`id`, `fullname`, `email`, `phone_number`, `password`, `forgot_token`, `active_token`, `status`, `create_at`, `update_at`) VALUES
(1, 'Huỳnh Minh Tâm', 'huynhminhtamm2002@gmail.com', '0878100084', 'hmtam2002', NULL, NULL, 1, '2024-06-01 17:09:27', NULL);
...
(23, NULL, '1717154234.jpg', 'slider', 1),
...
(14, 'chinh-sach-mua-hang', 'Chính sách mua hàng', '<p>Chính sách mua hàng</p>', 'policy', NULL, 1, '2024-05-28 08:11:57', '2024-05-30 10:53:10'),
...
(27, 'neu-co-ky-han-cho-moi-tinh', 'Nếu có kỳ hạn cho mối tình', '<p>Nếu có kỳ hạn cho mối tình</p>', 'new', '1717040396.jpg', 1, '2024-05-30 10:39:50', '2024-05-30 10:39:56'),
(29, 'la-lung-em-hoi', 'Lạ lùng em hỡi', '<p>Lạ lùng em hỡi</p>', 'new', '1717067823.jpg', 1, '2024-05-30 18:17:03', NULL);
